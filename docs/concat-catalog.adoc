...
* link:cores/safe-cli-pipeline.adoc[Safe CLI pipeline core]
  * `SafeCSV` + `SafeJson` + `SafeDateTime` + `SafeDecimal`
* link:cores/safe-scheduler-core.adoc[Safe scheduler core]
...
* See link:runtime-adapters.adoc[docs/runtime-adapters.adoc] for adapter guidance.
* See link:glue/minimal-idris-stubs.adoc[docs/glue/minimal-idris-stubs.adoc] for minimal glue sketches.
* See link:harnesses/example-harness-patterns.adoc[docs/harnesses/example-harness-patterns.adoc] for harness patterns.
* See link:core-registry.adoc[docs/core-registry.adoc] for the core registry table.
